...
class PersonalSecretBase(BaseModel):
    ...
    @field_validator("system_name", "password")
    @classmethod
    ...
    @field_validator("login_url", "username", "notes", "tags", mode="before")
    @classmethod
    def normalize_optional_text(cls, value: str | None, info) -> str | None:
        max_lengths = {"login_url": 1000, "username": 500, "notes": 4000, "tags": 500}
